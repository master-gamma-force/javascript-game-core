 ...
 * MIT Licensed
 */
e.exports=function(e){return"function"!=typeof Object.getOwnPropertySymbols?[]:Object.getOwnPropertySymbols(e).filter((function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))}},,function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var chai__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(17),chai__WEBPACK_IMPORTED_MODULE_0___default=__webpack_require__.n(chai__WEBPACK_IMPORTED_MODULE_0__);self.addEventListener("message",e=>{const userCode=e.data.code,testFunction=()=>{eval(e.data.test)};let result;try{userCode.replace("console.log","return"),result=(()=>{eval(userCode)})(),testFunction()}catch(e){errors={type:"error",error:error}}self.postMessage({result:result,errors:errors})},!1)},function(e,t,n){e.exports=n(1)},function(e,t,n){
/*!
 * chai
